...
public class Simulator {
    ...
    public Simulator(int simulationId, double qDelayTime, int kConnections, int availableSystemCalls, int nAvailableProcesses,
        ...
        clock = 0;
        totalSimulations = 0;
        this.maxTimeSimulation = timePerTrial;
        eventList = new PriorityQueue<>();
        this.availableSystemCalls = availableSystemCalls;

        setExecutionModule(new QueryExecutionerModule(this, mSentences));
        setTransactionAndDataAccessModule(new TransactionAdmModule(this, getExecutionModule(), pQueries));
        ...
        this.pConcurrentQueries = pQueries;
    ...
    public void setKillEventsTable(Hashtable<Integer, Event> killEventsTable) {
        this.killEventsTable = killEventsTable;
    }
}
